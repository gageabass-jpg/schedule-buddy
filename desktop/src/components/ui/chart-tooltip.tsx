// Chart tooltip (shadcn chart-tooltip style) from 21st.dev.
// Copied as supplied, with three changes so the card can be used on its own:
//  - the card (TooltipDemo) is also exported, as ChartTooltipCard;
//  - a row's value may be text as well as a number.
//  - rows keep a gap-4 between name and value, so a long name can't run into it.
// Colours come from the shadcn variables in src/index.css.
...
export { TooltipDemo as ChartTooltipCard };
