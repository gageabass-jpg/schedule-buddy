...
import { fmtDate, type ShiftMap, type Who, type Shift, type ShiftSource } from "./schedule";
...
export function selfShiftId(state: HouseholdState, dateISO: string): ResolvedSelfShift {
